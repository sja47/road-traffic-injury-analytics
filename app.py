...
with col1:
    ...
    fig1, ax1 = plt.subplots(figsize=(2.0, 1.8), dpi=110)
    ...
    ax1.legend(["Injury", "Death"], fontsize=4, loc='upper right', bbox_to_anchor=(1.0, 1.0))
    fig1.tight_layout(pad=0.4)
    st.pyplot(fig1, clear_figure=True)

with col2:
    st.markdown("**2. Yearly Death & Injury Trends**")
    fig2, ax2 = plt.subplots(figsize=(2.0, 1.8), dpi=110)
...
with col3:
    ...
    fig3, ax3 = plt.subplots(figsize=(2.0, 1.8), dpi=110)
...
with col4:
    ...
    fig4, ax4 = plt.subplots(figsize=(2.0, 1.8), dpi=110)
    ...
    ax4.legend(fontsize=4, loc="upper right", bbox_to_anchor=(1.2, 1))
