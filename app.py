...
with col1:
    ...
    fig1, ax1 = plt.subplots(figsize=(2.4, 2.2), dpi=110)
    ...
    ax1.legend(["Injury", "Death"], fontsize=5, loc='upper right', bbox_to_anchor=(1.0, 1.0))
    fig1.tight_layout(pad=0.5)
    st.pyplot(fig1, clear_figure=True)

with col2:
    st.markdown("**2. Yearly Death & Injury Trends**")
    fig2, ax2 = plt.subplots(figsize=(2.4, 2.2), dpi=110)
    ...
    ax2.set_ylabel("Rate per 100k", fontsize=7)
...
with col3:
    ...
    fig3, ax3 = plt.subplots(figsize=(2.4, 2.2), dpi=110)
...
with col4:
    ...
    fig4, ax4 = plt.subplots(figsize=(2.4, 2.2), dpi=110)
    age_gender_avg.plot(kind="bar", ax=ax4, width=0.7)
    ax4.set_ylabel("Rate per 100k", fontsize=7)
    ax4.set_xlabel("Age Group", fontsize=7)
    ax4.tick_params(axis='x', labelsize=6)
    ax4.tick_params(axis='y', labelsize=6)
    ax4.legend(fontsize=5, loc="upper right", bbox_to_anchor=(1.25, 1))
